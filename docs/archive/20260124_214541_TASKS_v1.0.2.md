...
## 3. Review & Testing
- [x] **Safety Check**: Verify "Stop" confirmation dialog works.
- [x] **Data Safety**: Test "Move" function carefully to ensure no data loss (backup first recommended during dev).
- [x] **Path Handling**: Test with paths containing spaces and different drives (C: vs D:).
