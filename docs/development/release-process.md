...
Before creating a release tag, ensure the following files are updated with the new version number (e.g., `2.0.3`):
...
3.  Commit changes: `chore: update versions to 2.0.3`.
4.  Tag the release: `git tag v2.0.3`.
5.  Push the tag: `git push origin v2.0.3`.
