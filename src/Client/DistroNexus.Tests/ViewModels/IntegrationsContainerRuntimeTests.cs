...
public sealed class IntegrationsContainerRuntimeTests
{
    ...
    {
        var instance = new WslInstanceViewModel(new WslInstance { Name = "Ubuntu", State = "Running", Version = 2 }, Mock.Of<ILogger>(), Mock.Of<IPowerShellModuleClient>(), Mock.Of<IDialogService>());
