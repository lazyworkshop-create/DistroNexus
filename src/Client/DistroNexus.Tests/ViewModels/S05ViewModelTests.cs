...
public sealed class S05ViewModelTests
{
    ...
    private static WslInstanceViewModel Instance() => new(new WslInstance { Name = "Ubuntu", State = "Running", Version = 2 }, Mock.Of<ILogger>(), Mock.Of<IPowerShellModuleClient>(), Mock.Of<IDialogService>());
}
