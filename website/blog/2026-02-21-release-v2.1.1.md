...
## Get Started
You can download the latest version from our [GitHub Releases page](https://github.com/LazyWorkshopCreate/DistroNexus/releases).

For a complete list of changes, please refer to the [CHANGELOG.md](https://github.com/LazyWorkshopCreate/DistroNexus/blob/master/CHANGELOG.md).
