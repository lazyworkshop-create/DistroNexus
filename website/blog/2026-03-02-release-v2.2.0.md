...
Get v2.2.0 from the [GitHub Releases page](https://github.com/LazyWorkshopCreate/DistroNexus/releases/tag/v2.2.0).

See the full [v2.2.0 Release Notes](https://github.com/LazyWorkshopCreate/DistroNexus/blob/master/docs/release_notes/v2.2.0.md) for a complete change breakdown.
