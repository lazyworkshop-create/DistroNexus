...
## 开始使用
您可以从我们的 [GitHub Releases 页面](https://github.com/LazyWorkshopCreate/DistroNexus/releases) 下载最新版本。

有关更改的完整列表，请参阅 [CHANGELOG.md](https://github.com/LazyWorkshopCreate/DistroNexus/blob/master/CHANGELOG.md)。
